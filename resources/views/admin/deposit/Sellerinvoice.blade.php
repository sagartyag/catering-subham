            ...
            <div class="container-fluid">
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Seller Invoice</a></li>
					</ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Seller Invoice</h4>
                            </div>
                            <div class="card-body">
                                <div id="example_wrapper" class="dataTables_wrapper" style="display: none">
                                                ...
                                                <?php $cnt = $deposit_list->perPage() * ($deposit_list->currentPage() - 1); ?>
                                                 @foreach($deposit_list as $value)
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td ><a href="{{ route('admin.view-seller-invoice', ['id'=> Crypt::encrypt($value->id)]) }}"><span class="badge bg-success">View Detail</span></a></td>
                                                  @endforeach
