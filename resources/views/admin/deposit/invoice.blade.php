                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="left strong">{{$value->productName}} </td>
                                                <td class="left">{{$value->ProductDiscription}}</td>
                                                <td class="right">&#8377; {{$value->productPrice}}</td>
                                                <td class="center">{{$value->quantity}} </td>
                                                <td class="right">&#8377; {{$value->productDiscountPrice}}</td>
                                            </tr>
