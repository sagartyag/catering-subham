            ...
            <div class="container-fluid">
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Billing Reports</a></li>
					</ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Billing Reports</h4>
                            </div>
                            <div class="card-body">
                                                ...
                                                <?php $cnt = $deposit_list->perPage() * ($deposit_list->currentPage() - 1); ?>
                                                 @foreach($deposit_list as $value)
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td ><a href="{{ route('admin.view-invoice', ['id'=> Crypt::encrypt($value->id)]) }}"><span class="badge bg-success">View Detail</span></a></td>
                                                  @endforeach
