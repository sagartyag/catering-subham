        ...
        ***********************************-->
                    ...
                    <div class="col-xl-8 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('admin.billingSubmitSeller') }}" method="POST">
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                // Add item to cart
                function addToCart(product, productDiscription, price, DiscountPrice, coupen, product_id,balance_quantity) {
                    var item = {
                        product: product,
                ...
                function updateCart() {
                    ...
                    cart.forEach(function(item) {
                        ...
                        row.append(
                            '<td><div class="me-3" style="width: 120px;"><input type="number" min="1" max="' +
                            item.balance_quantity + '" value="' +
                ...
                $('#cart').on('click', '.remove', function() {
                    ...
                    addToCart('{{ $product->product->productName }}', '{{ $product->product->ProductDiscription }}',
                        ...
                        {{ $product->product->ProductCoupon }}, {{ $product->id }},{{$balanceQuan}});
