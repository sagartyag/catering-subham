        ...
        <div class="content-body">
            <div class="container-fluid">
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						<li class="breadcrumb-item active"><a href="javascript:void(0)">Agent History</a></li>
						<li class="breadcrumb-item"><a href="javascript:void(0)">Agent History</a></li>
					</ol>
                </div>
                <!-- row -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Agent History</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($product_list as $value)
                                                <tr>
                                                    ...
                                                    <td><a  href="{{ route('admin.edit_member', ['id'=> Crypt::encrypt($value->id)]) }}" class="btn btn-primary"> <i class="fas fa-edit"></i> </a></td>
