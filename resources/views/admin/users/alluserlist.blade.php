                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div id="example_wrapper" class="dataTables_wrapper">
                                    <form action="{{ route('admin.totalusers') }}" method="GET" style="display: none">
                                        <div class="row">
                                            <div class="col-xl-4">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($alluserlist as $value)
                                                <tr>
                                                    ...
                                                    <td><span
                                                        class="badge bg-{{ $value->rank == 1 ? 'secondary' : 'info' }}">{{ ($value->rank)?"SELLER":"CUSTOMER" }}</span></td>
                                                    ...
                                                    <td>
                                                        @if($value->rank)
                                                            SELLER
                                                        @else
                                                        <a href="{{route('admin.sellerSubmit')}}?id={{$value->id}}&status=Block" class="badge green" style="    background: green;">Make a Seller </a>
                                                        @endif
                                                    </td>
