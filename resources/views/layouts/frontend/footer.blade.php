            ...
            <div class="rac_app_text">
              ...
              <div class="rac_app_stores">
                <a href="javascript:void(0);">
                  <img src="main/images/android.webp" class="img-fluid">
                </a>
                <a href="javascript:void(0);">
                  <img src="main/images/ios.webp" class="img-fluid">
                </a>
              </div>
            </div>
            <div class="rac_app_img">
              <img src="main/images/mob.webp" class="img-fluid">
              <img src="main/images/app_food.webp" class="img-fluid">
            </div>
          </div>
        </div>
        <div class="col-12">
      ...
      <div class="row">
        <div class="col-12">
          <div class="rac_copyright_text">
            <p>Copyright © <span id="copyYear"></span> Catering by Lalji Caterers. All Rights Reserved.</p>
          </div>
        </div>
      </div>
    </div>
...
<script src="main/js/lightgallery-all.min.js"></script>
